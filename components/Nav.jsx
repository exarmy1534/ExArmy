        ...
        <div className="flex justify-between items-center h-20  w-full px-10">
          ...
          <ul className="flex gap-10  w-full h-full justify-center items-center">
            <li>
              <Link
                href="/"
                className={`  font-semibold text-xl shrink-0 hover:text-[#FBBF24]/80 hover:text-[1.4rem] transition-all ${
                  pathname === "/" ? "text-[#FBBF24]" : "text-black"
                }`}
              >
                Home
              </Link>
            ...
            <li>
              <Link
                href="/about"
                className={` font-semibold shrink-0 text-xl hover:text-[#FBBF24]/80 hover:text-[1.4rem] transition-all ${
                  pathname === "/about" ? "text-[#FBBF24]" : "text-black"
                }`}
              >
                About
              </Link>
            ...
            <li>
              <Link
                href="/rent"
                className={` shrink-0  font-semibold text-xl hover:text-[#FBBF24]/80 hover:text-[1.4rem] transition-all ${
                  pathname === "/rent" ? "text-[#FBBF24]" : "text-black"
                }`}
              >
                Rent a Car
              </Link>
            ...
            <li>
              <Link
                href="/contact"
                className={` shrink-0  font-semibold text-xl hover:text-[#FBBF24]/80 hover:text-[1.4rem] transition-all ${
                  pathname === "/contact" ? "text-[#FBBF24]" : "text-black"
                }`}
              >
                Contact Us
              </Link>
          ...
          <Link href="/contact">
            <button
              ...
              className=" active:bg-black h-14 w-44 rounded-2xl bg-[#D97706] cursor-pointer hover:text-[#D97706]/60 transition-all ease-in-out flex items-center justify-center"
            >
